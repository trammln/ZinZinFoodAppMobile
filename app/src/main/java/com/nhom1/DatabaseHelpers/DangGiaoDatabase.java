...
public class DangGiaoDatabase extends SQLiteOpenHelper {
    ...
    public void createSampleData(){
        if(numbOfRows()==0)
        {
            execSql("INSERT INTO " + TBL_NAME + " VALUES(null, 'Bánh tráng bơ cuộn thơm ngon đặc biệt', 5, 10000, 8, 100000, 'Đang giao hàng', 'banhtrangbocuon')");
            execSql("INSERT INTO " + TBL_NAME + " VALUES(null, 'Bánh tráng rong biển cháy tỏi thơm ngon', 2,12000, 5, 80000, 'Đang vận chuyển','banhtrangrongbien')");
            execSql("INSERT INTO " + TBL_NAME + " VALUES(null, 'Bánh tráng sa tế tắc thơm cay ngon ngon',3, 10000, 10, 120000, 'Đang vận chuyển', 'banhtrangsatetac')");
            execSql("INSERT INTO " + TBL_NAME + " VALUES(null, 'Bánh tráng bơ cuộn thơm ngon đặc biệt', 1, 10000, 5, 70000, 'Đang lấy hàng', 'banhtrangbocuon')");
        }
    }
}
