...
public class DonMuaDatabase extends SQLiteOpenHelper {

    public static final String DB_NAME = "donmua.sqlite";
    public static final int DB_VERSION = 1;
    public static final String TBL_NAME = "DonMua";
    ...
    public DonMuaDatabase(@Nullable Context context) {
