...
public class SearchAdapter extends BaseAdapter {
    ...
    public SearchAdapter(Context context, String[] tenBestseller, int[] hinhBestseller, String[] giaBestseller) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view = layoutInflater.inflate(R.layout.gridview_search,null);
