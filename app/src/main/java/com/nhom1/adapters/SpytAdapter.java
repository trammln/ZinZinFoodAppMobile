...
public class SpytAdapter extends BaseAdapter {
    private Context context;
    private String[] tenBestseller;
    private int[] hinhBestseller;
    private String[] giaBestseller;

    public SpytAdapter(Context context, String[] tenBestseller, int[] hinhBestseller, String[] giaBestseller) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view = layoutInflater.inflate(R.layout.gridview_sanphamyeuthich,null);
        TextView txtTen = view.findViewById(R.id.spyt_Name);
        TextView txtGia = view.findViewById(R.id.spyt_Price);
        ImageView imgHinh = view.findViewById(R.id.spyt_Thumb);
