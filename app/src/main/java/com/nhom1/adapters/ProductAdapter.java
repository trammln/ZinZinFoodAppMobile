...
public class ProductAdapter extends BaseAdapter {
    ...
    ProductPage activity;
    int item_layout;
    List<Product> productList;

    public ProductAdapter(ProductPage activity, int item_layout, List<Product> productList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            holder.txtSearch = view.findViewById(R.id.txtAutocompleteTextView);
            view.setTag(holder);
        }
        else{
    ...
    public static class ViewHolder{
        TextView txtName, txtPrice, txtSold, txtRate, txtSearch;
        ImageView imvThumb;
    }
}
